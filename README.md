...
ping x.x.x.x                  # test connectivity to host
```
...
This project incorporates several open-source components, each governed by its own license:

| Component | License | Copyright |
|-----------|---------|-----------|
| **fsmsggen** (message generator) | [MIT](Project_FsMsgGen/fsmsggen/LICENSE) | 2022 fillabs |
| **itscertgen/cshared** (build framework) | [MIT](Project_FsMsgGen/itscertgen/cshared/LICENSE) | 2020 fillabs |
| **liboqs** (quantum-safe library) | [MIT](Project_FsMsgGen/liboqs/LICENSE.txt) | 2016-2024 The Open Quantum Safe project authors |
| **asn1c** (ASN.1 compiler) | [BSD 3-Clause](Project_FsMsgGen/asn1c/LICENSE) | 2003-2017 Lev Walkin & contributors |
| **TS.ITS** (ETSI test suite) | [BSD 3-Clause](Project_FsMsgGen/TS.ITS/LICENSE) | 2019 ETSI |

Full license texts are available in the respective subdirectories under `Project_FsMsgGen/`.

The original code (certificate generator extensions, PQC integration layer, benchmark) produced as part of this thesis is made available under the same permissive terms as the upstream components.
